...
////                namesAndPrices[i][3] = new TextView( this );
//                charviews[i][0].setText( "Name " + character.getName( ) );
//                charviews[i][1].setText( "Alignment " + character.getAlignment( ));
////                namesAndPrices[i][2].setText("Class " + character.getCharclass( ));
////                namesAndPrices[i][3].setText("Race " + character.getRace( ));
//                charviews[i].
//
//
//                // create the button
...
//                grid.addView( ids[i], width/2, ViewGroup.LayoutParams.WRAP_CONTENT );
//                grid.addView( charviews[i][0], ( int ) ( width * .4 ),
//                        ViewGroup.LayoutParams.WRAP_CONTENT );
//                grid.addView( charviews[i][1], ( int ) ( width * .25 ),
//                        ViewGroup.LayoutParams.WRAP_CONTENT );
////                grid.addView( namesAndPrices[i][2], ( int ) ( width * .4 ),
////                        ViewGroup.LayoutParams.WRAP_CONTENT );
////                grid.addView( namesAndPrices[i][3], ( int ) ( width * .25 ),
////                        ViewGroup.LayoutParams.WRAP_CONTENT );
//
//                i++;
//            }
